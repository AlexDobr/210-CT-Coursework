...
public:
	...
	void deleteNode(Node* node) {
		...
		// change pointers of neighbouring nodes depending on whether this is the first node 
		if (node->prev != 0)
		{
		...
		// change pointers of neighbouring nodes depending on whether this is the last node 
		if (node->next != 0)
		{
